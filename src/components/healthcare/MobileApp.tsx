      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="flex-shrink-0 relative">
            ...
            <div className="absolute -inset-6 sm:-inset-8 bg-gray-50 rounded-full -z-10" />

            <div className="w-44 h-[320px] sm:w-56 sm:h-[400px] bg-gray-900 rounded-[2rem] sm:rounded-[2.5rem] p-2 sm:p-2.5 shadow-2xl relative">
                    ...
                    {appFeatures.slice(0, 4).map((f) => (
                      ...
                      >
                        <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-md sm:rounded-lg bg-teal/10 flex items-center justify-center mx-auto mb-0.5 sm:mb-1">
                          <f.icon size={12} className="text-teal sm:hidden" />
                          <f.icon size={16} className="text-teal hidden sm:block" />
                        </div>
                  ...
                  <div className="mt-2 sm:mt-2.5 bg-gray-50 border border-gray-100 rounded-lg sm:rounded-xl p-2 sm:p-2.5">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-teal/10 flex items-center justify-center">
                        <CalendarCheck size={10} className="text-teal sm:hidden" />
                        <CalendarCheck size={12} className="text-teal hidden sm:block" />
                      </div>
                      <div>
            ...
            {/* Floating notification - hidden on small mobile */}
            <div className="absolute -right-2 sm:-right-4 top-10 sm:top-14 bg-white rounded-lg sm:rounded-xl p-2 sm:p-2.5 shadow-lg border border-gray-100 w-28 sm:w-36">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-md sm:rounded-lg bg-green-50 flex items-center justify-center">
                  <CalendarCheck size={11} className="text-green-500 sm:hidden" />
                  <CalendarCheck size={13} className="text-green-500 hidden sm:block" />
                </div>
                <div>
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-2 sm:mb-3">
              Healthcare at Your Fingertips
            </h2>

            <p className="text-gray-500 text-sm sm:text-base leading-relaxed max-w-md mx-auto lg:mx-0 mb-6 sm:mb-8">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-5 mb-6 sm:mb-8">
              {appFeatures.map((f) => (
                <div key={f.label} className="flex flex-col items-center gap-1 sm:gap-1.5 group cursor-default">
                  ...
                  >
                    <f.icon size={16} style={{ color: f.color }} className="sm:hidden" />
                    <f.icon size={20} style={{ color: f.color }} className="hidden sm:block" />
                  </div>
                  <span
                    className="text-[9px] sm:text-[10px] font-semibold text-center leading-tight max-w-[64px] sm:max-w-[72px]"
                    style={{ color: f.color }}
                  >
                    {f.label}
                  </span>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 sm:gap-3">
              <button className="flex items-center gap-2 sm:gap-2.5 bg-black rounded-lg sm:rounded-xl px-4 sm:px-5 h-10 sm:h-11 hover:bg-gray-800 transition-all shadow-sm">
                ...
                <div className="text-left">
                  <div className="text-[7px] sm:text-[8px] text-gray-300 leading-none">Download on the</div>
                  <div className="text-[10px] sm:text-xs font-semibold text-white leading-tight">App Store</div>
                </div>
              </button>
              ...
              <button className="flex items-center gap-2 sm:gap-2.5 bg-black rounded-lg sm:rounded-xl px-4 sm:px-5 h-10 sm:h-11 hover:bg-gray-800 transition-all shadow-sm">
                ...
                <div className="text-left">
                  <div className="text-[7px] sm:text-[8px] text-gray-300 leading-none">Get it on</div>
                  <div className="text-[10px] sm:text-xs font-semibold text-white leading-tight">Google Play</div>
                </div>
              </button>
            </div>
          </div>
